...
public class CourseCommentCmsServiceImpl implements CourseCommentCmsService {
    ...
    @Override
    public List<CourseComment> queryCourseCommentByQueHql(int pageIndex, int limit, String key_words, String phone_number, String article_name, String user_name, Integer comment_type, String query_start_time, String query_end_time, Integer sort_role, String comment_root_id, String id,String courseId) {
        ...
        stringBuffer.append("SELECT new com.memory.entity.bean.CourseComment(ac.id, ac.userName, us.userTel, a.courseTitle, ac.commentContent,ac.commentTotalLike, (select count(*) from CourseComment WHERE commentRootId = ac.commentRootId  AND commentRootId <> id ) as commentSum," +
                "ac.commentCreateTime,ac.commentRootId , ac.commentType,ac.commentParentId,ac.commentParentUserName,ac.commentContentReplace,ac.courseId,ac.commentParentContent) " +
        ...
        Map<String,Object> whereClause = getWhereClause(key_words, phone_number, article_name, user_name, comment_type, query_start_time, query_end_time, sort_role,comment_root_id,id,courseId);
    ...
    @Override
    public int queryCourseCommentByQueHqlCount(String key_words, String phone_number, String article_name, String user_name, Integer comment_type, String query_start_time, String query_end_time, Integer sort_role, String comment_root_id, String id,String courseId) {
     ...
     * @return
     */
    public Map<String,Object> getWhereClause(String key_words,String phone_number, String article_name, String user_name, Integer comment_type, String query_start_time, String query_end_time, Integer sort_role,String comment_root_id, String id,String courseId){
        Map<String,Object> returnMap = new HashMap<String, Object>();
        StringBuffer stringBuffer = new StringBuffer();
        Map<String,Object> paramMap = new HashMap<String, Object>();

        if(Utils.isNotNull(courseId)){
            stringBuffer.append(" AND ac.courseId = :courseId  ");
