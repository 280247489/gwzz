...
import com.memory.cms.entity.Ext;
...
public class CourseExtController {
    ...
    public Result /*List<Ext> */ add( ExtModel extModel){
        ...
        try{
          ...
          //  System.out.println("json ======================================" + JSON.toJSONString(extList) );
            ...
            List<CourseExt> extListSave = courseExtService.saveAll(list);
    ...
    public Result /*List<Ext> */ update( ExtModel extModel){
        ...
        try{
            ...
            List<CourseExt> removeList = courseExtService.queryCourseExtListByCourseId(list.get(0).getCourseId());
            //删除原数据并保存新数据(事物方法)
            List<CourseExt> extListSave =  courseExtService.deleteAndSave(removeList,list);
            //List<CourseExt> extListSave = courseExtService.saveAll(list);
            result = ResultUtil.success(extListSave);
    ...
    public Result queryCourseExtListByCourseId(@RequestParam("courseId") String courseId){
        Result result = new Result();
        try {
            List<CourseExt> list =  courseExtService.queryCourseExtListByCourseId(courseId);
