package com.memory.gwzz.entity;
...
public class ArticleExt {
    ...
    private Date articleExtCreateTime;
    ...
    public Date getArticleExtCreateTime() {
        return articleExtCreateTime;
    }

    public void setArticleExtCreateTime(Date articleExtCreateTime) {
