jQuery(document).ready(function () {
    ...
    var url = api_back + '/courseComment/cms/list';
    var re_comment = api_back + '/courseComment/cms/add';
    var remove_comment = api_back + '/courseComment/cms/remove';
    var lk = 0;
            ...
            if (content['0'] == '' || content['0'] == undefined) {
                ...
                $.each(content, function (i, n) {
                    ...
                    if (n.commentType == '0') {
                        ...
                        _view = '<a class="view_comment btn btn-sm btn-primary" href="commentCourseView.html?action=view&id=' + n.id + '&commentType=' + n.commentType + '&commentRootId=' + n.commentRootId + '">查看</a>&nbsp;';
                    ...
                    tr += '<tr data-id="' + n.id + '" data-rid="' + n.commentRootId + '" data-type=' + n.commentType + ' data-pid="' + n.commentParentId + '">' +
                        ...
                        '<td>' + _view + '<a class="re_comment btn btn-sm btn-primary" href="javascript:void(0);">回复</a>&nbsp;<a class="remove_comment btn btn-sm btn-primary" href="javascript:void(0);">删除</a> </td>' +
                        '</tr>';
                });
            }
